...
import testScence from '../assets/test/snake.glb'
...
const Snake2 = ({ ...props }) => {
    ...
    const stopTime = 10; // when the play time is 5 sec, stop the play and restart from beginning
    const startTime = 1; // Set your desired start time here (in seconds)
    ...
    useEffect(() => {
        ...
        let action = actions['Armature|Action'];
        if (!action) {
